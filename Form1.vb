...
Public Class Form1
    ...
    Private Sub Load_JSON()
        ...
        Try
            ...
            json = New WebDownload(2000).DownloadString("https://api.blockchair.com/groestlcoin/nodes")
    ...
    Private Sub Setup_Logging()
        ...
        Try
            Dim LogFileDirectory As String = "C:\Users\" + Environment.UserName + "\AppData\Local\GRSNodes"
            ...
            LogFileName = LogFileDirectory + "\grsnodes.log"
        Catch
    ...
    Private Sub Set_Up_Map_Cache()
        ...
        Try
            ...
            MapCacheFileName = "C:\Users\" + Environment.UserName + "\AppData\Local\GRSNodes\IP_Location.txt"
    ...
    Private Sub Set_Up_JSON_Persistence()
        ...
        Try
            ...
            JSONFileName = "C:\Users\" + Environment.UserName + "\AppData\Local\GRSNodes\JSON.txt"
    ...
    Private Sub GRSNodes_Version()
        ...
        Try
            ...
            Try
                ...
                jsonVersion = client.DownloadString("https://api.github.com/repos/starglancer/grsnodes/releases/latest")
    ...
    Private Sub btnRunGRScoinNode_Click(sender As Object, e As EventArgs) Handles btnRunGRScoinNode.Click

        'Go to link to running your own node
        Process.Start(My.Settings.GRScoinCoreURL)
    ...
    Private Sub Configure_Map_Control()
        ...
        Try
            ...
            MapControl1.CacheFolder = "C:\Users\" + Environment.UserName + "\AppData\Local\GRSNodes\MapControl"
            MapControl1.TileServer = New OpenStreetMapTileServer("starglancer/grsnodes/" + My.Computer.Name)
    ...
    Private Sub btnClearMapCache_Click(sender As Object, e As EventArgs) Handles btnClearMapCache.Click
        ...
        Try
            Dim MapCacheDirectory As String = "C:\Users\" + Environment.UserName + "\AppData\Local\GRSNodes\MapControl"
